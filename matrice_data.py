...
df = pd.read_csv('deputy_votes_new_last2.csv', encoding='ISO-8859-1')

# Créer une liste de tous les députés uniques
deputies = df['deputy_name'].unique()

# Créer une liste de tous les scrutins uniques
...
for deputy in deputies:
    ...
    for scrutin_number in scrutin_numbers:
        vote_value = 2  # Par défaut, on considère que les données ne sont pas disponibles
...
# Exporter le DataFrame résultant dans un nouveau fichier CSV
matrix_df.to_csv('matrice_votes_deputes.csv')
